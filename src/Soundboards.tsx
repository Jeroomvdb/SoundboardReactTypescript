...
export default function Soundboards() {
  ...
  if (!soundboards) {
    // Dit gaat je waarschuwen, maar doet niets indien je soundboards niet geladen zijn. return van deze functie of render een loader
